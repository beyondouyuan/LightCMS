                ...
                <main class="web-main_wrapper">
                    ...
                    <section class="sidebar-container">
                        <web-sidebar
                            ...
                            :hotTags="hotTags"
                            :hotMembers="hotMembers"
                            :hotBanner="hotBanner"></web-sidebar>
                    </section>
                </main>
            </section>
        </section>
...
import WebSidebar from '~/components/Client/Sidebar'
...
export default {
    ...
    computed: mapState(['loginState', 'menus', 'current', 'hotArticle', 'hotTags', 'hotMembers', 'hotBanner']),
    methods: {
